...
// Основная палитра - черно-белая схема с фиолетовыми акцентами
...
val AccentPurple = Color(0xFF8B5CF6) // Главный цвет - современный фиолетовый
...
// Новая цветовая схема - минималистичная
...
// Цвета для настроений - более сдержанные и стильные
...
val AccentYellow = AccentPurple // Заменяем желтый на фиолетовый

// Динамический CardBackground в зависимости от темы
@Composable
